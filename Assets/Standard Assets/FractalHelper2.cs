...
public static class FractalHelper2
{
    ...
    static int GetNewVertex4(int i1, int i2)
    {
		...
		var tempDist = Vector3.Distance(vertices[i1], vertices[i2])/12.0f;
...
//Debug.Log(tempVert);
//Debug.Log(vertices[i1].y);
//Debug.Log(vertices[i2].y);
//Debug.Log(vertices[i3].y);
		float tempDist = Vector3.Distance(vertices[i1], vertices[i2])/12.0f;
